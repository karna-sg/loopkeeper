...
describe("EngStore: artifacts + budget", () => {
  ...
  it("merge-patches artifacts without clobbering other stages", () => {
    const plan: PlanArtifact = { text: "the plan", editedText: null, sessionId: "sess-1", revision: 0, generatedTs: NOW, approvedTs: null, approvedBy: null, summary: null, steps: null, changedFiles: null, newTests: null, riskFlags: null };
